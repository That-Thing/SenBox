$(document).ready(function(){
    ...
    $("#banned-mimes").on("click", ".add-mime", function(){
        ...
        <span class="d-flex mime-field">
            <input autocomplete="off" class="form-control form-control-sm mt-1 ms-1 w-25 me-2 mime-input" type="text" placeholder="ex: application/zip" name="mime-${parseInt($("#mime-count").val()) + 1}">
